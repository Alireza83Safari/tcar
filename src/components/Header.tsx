    ...
    <header className="xl:container mx-auto md:px-8 px-2 sticky top-0 z-10 bg-white shadow-lg">
      <div className="flex justify-between items-center h-[4rem] relative">
        ...
        >
          ...
          >
            <p className="hover:text-purple duration-300 lg:flex block lg:py-0 py-3">
              خرید خودرو
            </p>
          </Link>
          ...
          <div className="relative group z-20 flex justify-center">
            <div>
              <button className="flex items-center lg:justify-normal justify-center">
                ...
                <p className="hover:text-purple duration-300 flex justify-center items-center lg:py-0 py-3">
                  اکانت
                </p>
              </button>
